...
const Chatbot = () => {
  const steps = [
    {
      id: "Greet",
      message: "Hello, Welcome WellBeing Campus",
      trigger: "Ask Name",
    },
    {
      id: "Ask Name",
      message: "I'm your friendly virtual assistant.May I ask for your name?  ",
      trigger: "waiting",
    },
    {
      id: "waiting",
  ...
  
  {
      id: "Question1x",
      options: [
        { value: "Balancing work and personal life is tough", label: "Balancing work and personal life is tough", trigger: "Question1.1x" },
  ...
  trigger:"Question1.1"    
    ...
    {
      id: "Question1.1.1",
      message: "Great! One effective strategy is to allocate specific time blocks for different activities. For instance, schedule dedicated study sessions and breaks.",
  end:true,
    },		
